(function (global, factory) {
  ...
  function audioSwitchPlugin(options) {
      ...
      const onAudioTracksChange = (player, audio) => {
          ...
          if (enabledTrack) {
              ...
              if (isPlaying)
                  player.pause();
              audio.src = audioTracksFromOptions.find((audioTrack) => audioTrack.language === enabledTrack.language)?.url;
  ...
  videojs__default["default"].registerPlugin("audio-switch", audioSwitchPlugin);
